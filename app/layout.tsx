      ...
      <body className={`${inter.className} bg-[#F9FAFB] text-gray-900 pb-24 selection:bg-blue-100`}>
        ...
        <header className="bg-[#F9FAFB] pt-8 pb-4 px-6 sticky top-0 z-10">
          <div className="flex justify-between items-center max-w-md mx-auto">
            <span className="text-xl font-bold tracking-tight">Healthne.</span>
        ...
        <nav className="fixed bottom-6 left-0 right-0 z-50">
          <div className="max-w-xs mx-auto bg-white/90 backdrop-blur-md shadow-lg border border-gray-100 rounded-full px-6 py-3 flex justify-between items-center text-gray-400">
            <Link href="/" className="p-2 hover:text-blue-600">
            ...
            <Link href="/ai" className="p-2 hover:text-blue-600">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" /></svg>
            </Link>
            <Link href="/feed" className="p-2 hover:text-blue-600">
